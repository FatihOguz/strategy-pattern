...
/**
 * this class implements LinearEquation interface
 * solve matris equation
 *
 */
public class LinearMatrisEquation implements LinearEquation {
    /**
     * implemets linear equatin
     */
    @Override
    public void linearEquation(){

        System.out.println("MATRIX INVERSION EQUATION");
        System.out.println("matrix size for MATRIX INVERSION EQUATION:");
    ...
    /**
     * jelping method for linearequation
     * @param a matris
     */
